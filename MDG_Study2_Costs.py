...
_thisDir = os.path.dirname(os.path.abspath('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG/')) 
os.chdir(_thisDir)

# Store info about the experiment session
expName = 'MDG_Sudy2_Cost'  # from the Builder filename that created this script
...
Test3pics=''
Test4pics=''
GENpics=[('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/fever.png'),('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/rash.png'),('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/migraine.png'),('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/ache.png')]
np.random.shuffle(GENpics)
MRIpics=[('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/MRI - POS.png'),('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/MRI - NEUT.png'),('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/MRI - NEG.png')]
LABpics=[('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/LAB - POS.png'),('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/LAB - NEUT.png'),('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/LAB - NEG.png')]
XRAYpics=[('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/RAY - POS.png'),('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/RAY - NEUT.png'),('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/RAY - NEG.png')]
CATpics=[('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/CAT - POS.png'),('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/CAT - NEUT.png'),('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/CAT - NEG.png')]
...
backgroundinst1 = visual.ImageStim(win=win, name='backgroundinst1',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/instructionsbackground.png', mask=None,
...
outcomesimage = visual.ImageStim(win=win, name='outcomesiamge',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/outcomes.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
...
backgroundinst4 = visual.ImageStim(win=win, name='backgroundinst4',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/instructions4.1.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
...
backgroundinst42 = visual.ImageStim(win=win, name='backgroundinst4',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/instructions4.2.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
...
backgroundinst43 = visual.ImageStim(win=win, name='backgroundinst4',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/instructions4.3.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
...
dplinst5 = visual.ImageStim(win=win, name='dplinst5',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/instructions5.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-1.0)
...
backgroundinst6 = visual.ImageStim(win=win, name='backgroundinst6',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/instructions6.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
...
instr7pic = visual.ImageStim(win=win, name='instr7pic',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/instructions7.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
...
dplinst8 = visual.ImageStim(win=win, name='dplinst8',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/instructions8.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-1.0)
...
startglow = visual.ImageStim(win=win, name='startglow',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/startglow.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-1.0)
startpic = visual.ImageStim(win=win, name='startpic',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/start.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-2.0)
...
background = visual.ImageStim(win=win, name='background',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/TrialBackground.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
loadingpic = visual.ImageStim(win=win, name='loadingpic',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/loading.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-1.0)
...
learningbackground = visual.ImageStim(win=win, name='learningbackground',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/learningbackground.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
...
# Initialize components for Routine "Costinstructions"----------------------------------------------------------------------------------------------------------------------------------------------------------
CostinstructionsClock = core.Clock()
backgroundinst2 = visual.ImageStim(win=win, name='Costinstructions',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/instructionsbackground.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
...
Costinstructionstext = visual.TextStim(win=win, name='CostinstructionsText',
    text=u'',
    font=u'BatmanForeverAlternate',
    units='pix', pos=(0, 0),height=30, wrapWidth=1200, color=u'#FCC700', colorSpace=u'rgb', opacity=1)
...
learningphaseend = visual.ImageStim(win=win, name='background1phase2',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/learningphaseend.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
...
instructionsbtwrounds = visual.ImageStim(win=win, name='instructionsbtwrounds',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/instructionsbtwrounds.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
...
background1phase2 = visual.ImageStim(win=win, name='background1phase2',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/instructions2phase2.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
...
background3phase2 = visual.ImageStim(win=win, name='background1phase2',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/instructions3phase2.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
...
resultsbackground = visual.ImageStim(win=win, name='resultsbackground',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/results.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
...
goodbye = visual.ImageStim(win=win, name='goodbye',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/goodbye.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-10.0)
goodbyeglow = visual.ImageStim(win=win, name='goodbyeglow',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/goodbyeglow.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
...
instructions9 = visual.ImageStim(win=win, name='instructions9',units='pix', 
    image=u'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/instructions9.png', mask=None,
    ori=0, pos=[0, 0], size=[1920,1080],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
...
instructions43Components.append(backgroundinst43)
...
while continueRoutine:
    ...
    if t >= 0.0 and backgroundinst43.status == NOT_STARTED:
        backgroundinst43.tStart = t
        backgroundinst43.frameNStart = frameN
        backgroundinst43.setAutoDraw(True)
...
learningtrials = data.TrialHandler(nReps=6, method=u'random', 
    extraInfo=expInfo, originPath=None,
    trialList=data.importConditions('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG/conditions1.xlsx'),
...
#------Prepare to start Routine "Costinstructions"-----------------------------------------------------------------------------------------------------------------------------------------------------------------
t = 0
CostinstructionsClock.reset()  # clock 
frameN = -1
# update component parameters for each repeat
inst_key_resp_1 = event.BuilderKeyResponse()  # create an object of type KeyResponse
inst_key_resp_1.status = NOT_STARTED
# keep track of which components have finished
CostinstructionsComponents = []
CostinstructionsComponents.append(backgroundinst1)
CostinstructionsComponents.append(inst_key_resp_1)
CostinstructionsComponents.append(Costinstructionstext)
for thisComponent in CostinstructionsComponents:
    if hasattr(thisComponent, 'status'):
        thisComponent.status = NOT_STARTED

#-------Start Routine "Costinstructions"-------
continueRoutine = True
while continueRoutine:
    # get current time
    t = CostinstructionsClock.getTime()
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    ...
    if t >= 0.0 and backgroundinst1.status == STARTED:
        Costinstructionstext.text = 'IN THIS NEXT PHASE IT WILL COST YOU $100 TO VIEW A TEST.\n\n THE DOLLARS THAT YOU HAVE EARNED FROM CORRECT DIAGNOSES WILL BE USED TO PAY FOR TESTS.\n\n THE TOTAL COSTS WILL THEN BE DEDUCTED FROM YOUR FINAL SCORE.\n\n IF YOU HAVE ANY QUESTIONS PLEASE ASK THE EXPERIMENTER.'
        Costinstructionstext.setAutoDraw(True)
...
#-------Ending Routine "Costinstructions"-------
for thisComponent in CostinstructionsComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
...
genoutcome_map = {
'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/fever.png': 1,
'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/rash.png': 2,
'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/migraine.png': 3,
'X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG//Images/ache.png': 4,
}
...
trials = data.TrialHandler(nReps=2, method=u'random', 
    extraInfo=expInfo, originPath=None,
    trialList=data.importConditions('X:/Psychology/ResearchProjects/JAHoffmann/PhDCremenAITeams/Projects/Study2/Medical_Diagnosis_Game/MDG/conditions2.xlsx'),
...
for thisTrial in trials:
    ...
    totalclick = 0
    testsRemaining = 4  # Number of tests remaining
